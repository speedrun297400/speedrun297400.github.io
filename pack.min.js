!function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,(function(r){var n;return o(e[i][1][r]||r)}),p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r}()({1:[function(require,module,exports){"use strict";var __createBinding=this&&this.__createBinding||(Object.create?function(o,m,k,k2){void 0===k2&&(k2=k),Object.defineProperty(o,k2,{enumerable:!0,get:function(){return m[k]}})}:function(o,m,k,k2){void 0===k2&&(k2=k),o[k2]=m[k]}),__setModuleDefault=this&&this.__setModuleDefault||(Object.create?function(o,v){Object.defineProperty(o,"default",{enumerable:!0,value:v})}:function(o,v){o.default=v}),__importStar=this&&this.__importStar||function(mod){if(mod&&mod.__esModule)return mod;var result={};if(null!=mod)for(var k in mod)"default"!==k&&Object.prototype.hasOwnProperty.call(mod,k)&&__createBinding(result,mod,k);return __setModuleDefault(result,mod),result},__awaiter=this&&this.__awaiter||function(thisArg,_arguments,P,generator){function adopt(value){return value instanceof P?value:new P((function(resolve){resolve(value)}))}return new(P||(P=Promise))((function(resolve,reject){function fulfilled(value){try{step(generator.next(value))}catch(e){reject(e)}}function rejected(value){try{step(generator.throw(value))}catch(e){reject(e)}}function step(result){result.done?resolve(result.value):adopt(result.value).then(fulfilled,rejected)}step((generator=generator.apply(thisArg,_arguments||[])).next())}))},__importDefault=this&&this.__importDefault||function(mod){return mod&&mod.__esModule?mod:{default:mod}};Object.defineProperty(exports,"__esModule",{value:!0});const crypo=__importStar(require("./src/crypo")),path_browserify_1=__importDefault(require("path-browserify")),streamsaver_1=__importDefault(require("streamsaver"));let fileIsHere=!1,working=!1;function sleep(ms){return new Promise(resolve=>setTimeout(resolve,ms))}function getOS(){let userAgent=window.navigator.userAgent.toLowerCase(),macosPlatforms,windowsPlatforms=/(win32|win64|windows|wince)/i,iosPlatforms=/(iphone|ipad|ipod)/i,os=null;return/(macintosh|macintel|macppc|mac68k|macos)/i.test(userAgent)?os="macos":iosPlatforms.test(userAgent)?os="ios":windowsPlatforms.test(userAgent)?os="windows":/android/.test(userAgent)?os="android":!os&&/linux/.test(userAgent)&&(os="linux"),os}function setprogbar(params){try{const progbar=document.querySelector("progress");null!==progbar&&(progbar.value=params)}catch(error){console.log(error)}}function checkRequirementVaild(){function Invaild(message="권장사양을 충족하지 않는 기기입니다."){const infoDom=document.getElementById("info");null!==infoDom&&(infoDom.innerText=message)}window.navigator.userAgent.toLowerCase().includes("wv")&&Invaild("웹뷰로 사용중입니다. 브라우저로 사용하지 않으면 오류가 발생할 수 있습니다");const root=document.querySelector(":root");if(root)if(window.screen.width<window.screen.height){console.log("big"),root.style.setProperty("--main-width","90vw");const liArray=Array.prototype.slice.call(document.querySelectorAll(".ele")),topMar=document.getElementById("topmar");for(const i in liArray)liArray[i].style.fontSize="40px",liArray[i].style.height="10vh";topMar&&(topMar.style.marginTop="10vh",console.log("bigger"))}else console.log("smol"),root.style.setProperty("--main-width","40vw");else console.log("smol")}function main(){return __awaiter(this,void 0,void 0,(function*(){const fileInputDom=document.getElementById("file"),passwordDom=document.getElementById("password"),encryptButton=document.getElementById("en"),decryptButton=document.getElementById("de"),fileLabel=document.getElementById("fileLabel"),winLink=document.getElementById("win"),extname=".ashs";if(document.title=".ashs".toUpperCase(),null===fileInputDom||null===passwordDom||null===encryptButton||null===decryptButton||null===fileLabel||null===winLink)return yield sleep(10),void main();function Crypt(isEncrypt=!0){return __awaiter(this,void 0,void 0,(function*(){if(working)return void alert("다른 작업이 실행중입니다.");if(!1===fileIsHere||null===fileInputDom.files)return void alert("파일이 존재하지 않습니다!");working=!0;const password=passwordDom.value;let chunks=-1;const divv=document.getElementById("cas");function parseFile(file,filename){return new Promise(callback=>{const fileStream=streamsaver_1.default.createWriteStream(filename),writer=fileStream.getWriter();if(!1===fileIsHere||null===fileInputDom.files)return;let chunk=1024e4;isEncrypt||(chunk+=43);let offset=0,fr=new FileReader;function startReading(){return __awaiter(this,void 0,void 0,(function*(){continue_reading()}))}function continue_reading(){return __awaiter(this,void 0,void 0,(function*(){try{if(offset>=file.size)return setprogbar(1),writer.close(),void callback();let slice=file.slice(offset,offset+chunk);chunks+=1,setprogbar(offset/file.size),console.log(`${offset} / ${file.size} | ${chunks} | ${offset/file.size*100}%`),fr.readAsArrayBuffer(slice)}catch(error){console.log(error),alert("파일을 합치는 데 오류가 발생했습니다"),working=!1}}))}fr.onload=function(){return __awaiter(this,void 0,void 0,(function*(){try{if("string"==typeof fr.result||null===fr.result)return;let temp;temp=isEncrypt?crypo.Encrypt(new Uint8Array(fr.result),password):crypo.Decrypt(new Uint8Array(fr.result),password),console.log("Dumping"),offset+=chunk,writer.write(temp),continue_reading()}catch(error){console.log(error),alert("오류가 발생했습니다"),working=!1}}))},fr.onerror=function(){callback()},startReading()})}null!==divv&&(divv.innerHTML="");for(let i=0;i<fileInputDom.files.length;i++){const fname=fileInputDom.files[i].name;if(void 0===fileInputDom.files[i]){window.alert("파일을 읽는데 실패하였습니다. 새로고침 후 다시 시도해 주세요");continue}if(isEncrypt&&".ashs"===path_browserify_1.default.parse(fname).ext&&!window.confirm("암호화하려는 파일이 이미 암호화 되어있습니다.\n정말 암호화하시겠습니까?"))continue;if(!isEncrypt&&".ashs"!==path_browserify_1.default.parse(fname).ext){window.alert("복호화하려는 파일의 확장자가 올바르지 않습니다.");continue}let fName;fName=isEncrypt?`${fname}.ashs`:`${path_browserify_1.default.parse(fname).name}`;const datas=yield parseFile(fileInputDom.files[i],fName);console.log("downloading..")}console.log("complete"),working=!1}))}"windows"===getOS()&&(winLink.style.visibility="visible",winLink.setAttribute("href","https://github.com/gramedcart/ASHS/wiki/ASHS-windows")),fileInputDom.onchange=()=>{null!==fileInputDom.files&&(fileInputDom.files.length<0||(fileInputDom.files.length>1?fileLabel.innerText=`${fileInputDom.files[0].name} 포함 총 ${fileInputDom.files.length}개의 파일`:fileLabel.innerText=fileInputDom.files[0].name,fileIsHere=!0))},encryptButton.onclick=()=>{Crypt(!0)},decryptButton.onclick=()=>{Crypt(!1)}}))}function isASCII(str){return/^[\x00-\x7F]*$/.test(str)}checkRequirementVaild(),main()},{"./src/crypo":203,"path-browserify":146,streamsaver:200}],2:[function(require,module,exports){
